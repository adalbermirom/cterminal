/*Lib terminal funções para Prisma 1.0
 * Linux version - (implementação win: terminalwin.c e terminalwin.h)
 * Author : Adalberto Amorim Felipe - adalbermirom@gmail.com
 * 
 * Lisence MIT 
 * 
*/
